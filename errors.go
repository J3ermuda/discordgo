...
var (
	...
	// ErrOutOfRange gets returned when the given value is out of the possible range
	ErrOutOfRange = errors.New("the given value is out of the possible range")
